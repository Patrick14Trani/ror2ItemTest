...
using R2API;
using R2API.Utils;
using RedHotRuby.Artifact;
using RedHotRuby.Equipment;
using RedHotRuby.Equipment.EliteEquipment;
using RedHotRuby.Items;
using System;
...
namespace RedHotRuby
{
    [BepInPlugin(ModGuid, ModName, ModVer)]
    [BepInDependency(R2API.R2API.PluginGUID, R2API.R2API.PluginVersion)]
    [NetworkCompatibility(CompatibilityLevel.EveryoneMustHaveMod, VersionStrictness.EveryoneNeedSameModVersion)]
    [R2APISubmoduleDependency(nameof(ItemAPI), nameof(LanguageAPI), nameof(ArtifactAPI), nameof(EliteAPI), nameof(ProjectileAPI), nameof(PrefabAPI))]
    public class Main : BaseUnityPlugin
    {
        public const string ModGuid = "com.FormulaPatty.RedHotRuby";
        public const string ModName = "Red Hot Ruby";
        ...
        private void Awake()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("RedHotRuby.rhr_assets"))
            {
